...
public class TB_EMPRESAS {
	...
	private boolean PESQUISA_RESPONDIDA;
	
	public boolean isPESQUISA_RESPONDIDA() {
		return PESQUISA_RESPONDIDA;
	}
	public void setPESQUISA_RESPONDIDA(boolean pESQUISA_RESPONDIDA) {
		PESQUISA_RESPONDIDA = pESQUISA_RESPONDIDA;
	}
